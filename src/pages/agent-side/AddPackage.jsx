                      ...
                      <div key={index} className="mb-4 border border-gray-300 rounded-md p-4">
                          ...
                          <FieldArray
                            ...
                            render={(arrayHelpers) => (
                              <div className="space-y-2">
                                {values.days[index].stays.map((stay, stayIndex) => (
                                  <div key={stayIndex} className="flex items-center">
                                    <Field
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => arrayHelpers.remove(stayIndex)}
                        ...
                        <div className="mb-4">
                          <FieldArray
                            ...
                            render={(arrayHelpers) => (
                              <div className="space-y-2">
                                {values.days[index].foods.map((food, foodIndex) => (
                                  <div key={foodIndex} className="flex items-center">
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => arrayHelpers.remove(foodIndex)}
                                      className="ml-2 text-red-500 hover:text-red-700"
                                    >
                                      Remove Food
                                    </button>
